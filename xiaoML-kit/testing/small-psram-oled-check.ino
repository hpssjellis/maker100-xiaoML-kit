...
// On the arudino IDE set TOOLS --> PSRAM to OPI PSRAM
...
void setup() {
  ...
  config.frame_size = FRAMESIZE_QVGA; //     FRAMESIZE_QCIF;// 176x144 // FRAMESIZE_HD;  1280x720 quality 10 // FRAMESIZE_VGA; 800 x 600 quality 8 // FRAMESIZE_QVGA; works--> 320x240 quality 3    //FRAMESIZE_UXGA; works  //1600 x 1200 // quality 10
