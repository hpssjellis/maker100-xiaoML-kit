## Maker100-name-to-change   (Economy) Robotics, IoT and TinyML Machine Learning course is almost ready to be used!
...
<details closed> <summary>Why Maker100-name-to-change?</summary>
