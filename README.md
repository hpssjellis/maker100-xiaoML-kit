...
|   `Already done-serial-putty`</a> Serial-putty or Linux "screen"         | This is a program to load on your computer that replaces the arduino serial monitor           |      |      Fairly easy once putty is installed. Load power shell and type mode with your Portenta programmed with a serial monitor program find the port. Then switch to Serial on Putty and Correct the COM port. Open and see if you can see serial output from the Portenta        |
...
| Topic | Example Code| Video | Instructions and Prompt |
|:---|:---|:---|:---|
|  <a name="a48" href="README.md#a48">`a48-XIAO ML Kit Motion`</a>   Make a motion machine learning model using your cell phone and load it onto the XIAO ML Kit   |     [edgeimpulse.com](https://studio.edgeimpulse.com/login)    The code to load onto the XIAO is converted from Edgeimpulse but for both the OLED and the motion which is #include <LSM6DS3.h>  which this code might help [xiaoML-6dof-imu-basics.ino](xiaoML-kit/xiaoML-6dof-imu-basics.ino)       |  <img src="https://img.youtube.com/vi/7Aucyd10Mtw/hqdefault.jpg" width=600 />       This is a full playlist so many other videos here might help  <img src="https://img.youtube.com/vi/wbX_-No8kIw/hqdefault.jpg" width=600 />       Probably best to do assignment a55 first.       |       |
